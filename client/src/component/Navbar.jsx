...
const Navbar = () => {
    ...
    return (
        <div className="w-full z-50">
            ...
            {/* TOP BAR */}
            {!scrolled && (
                <div className="bg-purple-900 text-white text-xs md:text-sm px-4 md:px-6 py-2 flex justify-between items-center">

                    <div className="hidden sm:block">
                        🔥 Upcoming Event: Youth Conference
                    </div>
                    ...
                    <div className="relative flex items-center">
                        <input
                            type="text"
                            placeholder="Search..."
                            className={`bg-white text-black px-3 py-1 rounded-md transition-all duration-300 
                            ${showSearch ? "w-40 md:w-48 opacity-100 mr-2" : "w-0 opacity-0 p-0"}`}
                        />

                        {showSearch ?
                            <FiX onClick={() => setShowSearch(false)} className="cursor-pointer" /> :
            ...
            {/* MAIN NAV */}
            <div className={`bg-purple-50 px-4 md:px-9 py-3 flex justify-between items-center shadow-md 
            ${scrolled ? "fixed top-0 w-full z-[9999]" : ""}`}>

                {/* LOGO */}
                <div className="flex items-center gap-2">
                    <img src={logo} className="w-12 md:w-16 h-12 md:h-16" />
                    <h6 className="text-purple-900 font-bold text-sm md:text-base">
                        FAME UNTOLD
                    </h6>
                </div>
                ...
                <div className="hidden md:flex gap-6 items-center font-bold text-gray-700">
                    ...
                    <Link className="text-sm lg:text-lg" to="/">Home</Link>
                    ...
                    >
                        <span className="cursor-pointer flex items-center gap-1 text-sm lg:text-lg">
                            About <FiChevronDown />
                        </span>

                        <div className={`absolute left-1/2 -translate-x-1/2 top-full p-6 bg-gray-50 shadow-xl rounded-b-xl 
                        grid grid-cols-2 gap-6 w-[650px] transition-all duration-300
                        ${openAbout ? "opacity-100 translate-y-0 z-[9999]" : "opacity-0 translate-y-4 pointer-events-none"}`}>
                            ...
                            <div className="bg-purple-900 text-white rounded-lg p-4">
                                ...
                                <img src={pics2} className="mt-2 h-32 object-cover rounded" />
                            </div>
                    ...
                    >
                        ...
                        <span className="flex items-center gap-1 text-sm lg:text-lg cursor-pointer">
                            Programs <FiChevronDown />
                        </span>

                        <div className={`absolute left-1/2 -translate-x-1/2 top-full p-6 bg-gray-50 shadow-xl rounded-b-xl 
                        grid grid-cols-3 gap-6 w-[850px] transition-all duration-300
                        ${openPrograms ? "opacity-100 translate-y-0 z-[9999]" : "opacity-0 translate-y-4 pointer-events-none"}`}>

                            <div>
                                <h3 className="font-semibold text-purple-900 mb-2">Programs</h3>
                                <ul className="space-y-2 text-sm text-gray-600">
                            ...
                            <div className="bg-purple-900 text-white rounded-lg p-4">
                                ...
                                <img src={pics1} className="mt-2 rounded object-cover" />
                            </div>

                        </div>
                    </div>

                    <Link className="text-sm lg:text-lg" to="/event-page">Events</Link>
                    <Link className="text-sm lg:text-lg" to="/media-page">Media</Link>
                    <Link className="text-sm lg:text-lg" to="/get-involved">Get Involved</Link>
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <Link to="/donation" className="bg-purple-900 text-white px-4 py-2 rounded-lg">
                        Donate
                    </Link>
                    ...
                    {user ? (
                        ...
                        <div className="relative" ref={profileRef}>
                            ...
                            {openProfile && (
                                <div className="absolute right-0 mt-4 bg-purple-50 shadow-lg rounded-lg w-56 z-[9999]">
                                    ...
                                    <button
                                        ...
                                        className="w-full p-3 text-white bg-purple-500 hover:bg-purple-600"
                                    >
                                        Logout
                                    </button>
                        ...
                        <div className="relative" ref={registerRef}>
                            ...
                            <button
                                ...
                                className="bg-purple-900 text-white px-4 py-2 rounded-lg flex items-center gap-1"
                            >
                                Account <FiChevronDown />
                            </button>

                            {openRegister && (
                                <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-lg w-48 z-[9999]">
            ...
            {mobileMenu && (
                ...
                <div className="fixed inset-0 bg-white z-[9999] p-6 overflow-y-auto">
                    ...
                    <ul className="space-y-5 text-lg font-bold">
                        ...
                        <li><Link to="/event-page" onClick={() => setMobileMenu(false)}>Events</Link></li>

                        <li><Link to="/media-page" onClick={() => setMobileMenu(false)}>Media</Link></li>

                        <li><Link to="/get-involved" onClick={() => setMobileMenu(false)}>Get Involved</Link></li>
