            ...
            {mobileMenu && (
                <div className="fixed inset-0 bg-white z-[9999] p-6 overflow-y-auto">
                    ...
                    <ul className="space-y-4 text-lg font-bold">
                        ...
                        <li>
                            <button onClick={() => setOpenAbout(!openAbout)} className="flex justify-between w-full items-center">
                                About <FiChevronDown />
                            </button>
                            {openAbout && (
                        ...
                        <li>
                            <button onClick={() => setOpenPrograms(!openPrograms)} className="flex justify-between w-full items-center">
                        ...
                        <li><Link to="/donation" onClick={() => setMobileMenu(false)}>Donate</Link></li>
                        ...
                        {user ? (
                            <>
                                <li className="mt-4">
                                    ...
                                    <label className="block mt-2 cursor-pointer p-2 bg-gray-100 rounded" >
                                        Upload Profile Image
                                        <input type="file" hidden onChange={handleImageUpload} />
                                    </label>
                                    <button onClick={handleLogout} className="w-full mt-2 p-2 bg-red-100 text-red-600 rounded">Logout</button>
                                </li>
                            </>
                        ) : (
